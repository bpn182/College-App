...
/**
 * Created by bpn18 on 1/12/2018.
 */

public class UserListActivityComp extends AppCompatActivity {
        ...
        for(final UserInfo info :list){
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(UserListActivityComp.this,DetailActivity.class);
