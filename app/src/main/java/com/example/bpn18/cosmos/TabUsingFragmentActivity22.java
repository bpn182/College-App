...
public class TabUsingFragmentActivity22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thu.setOnClickListener(tabclicklistener);
    ...
    public boolean onOptionsItemSelected(MenuItem item)  {
        ...
        switch (id){
            case R.id.sync:
                if (!isConnected(TabUsingFragmentActivity22.this)){ buildDialog(TabUsingFragmentActivity22.this).show();}
                else {

                    databaseHelper.deleteUserfrag();
                    //fetchData();
                    new StoreJSonDataInToSQLiteClass(TabUsingFragmentActivity22.this).execute();
        ...
        switch (id){
            case R.id.update:
                startActivity(new Intent(TabUsingFragmentActivity22.this,TabUsingFragmentActivity22.class));
                break;
        }
    ...
    public class StoreJSonDataInToSQLiteClass extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(TabUsingFragmentActivity22.this);
...

        {
            ...
            //Toast.makeText(TabUsingFragmentActivity22.this,"Load Done.. Press Update", Toast.LENGTH_LONG).show();
            //sundayFragment.populateData();
